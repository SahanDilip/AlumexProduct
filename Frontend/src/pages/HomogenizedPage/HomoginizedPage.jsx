        ...
        <form className="w-full">
          <div className="mb-4">
            <Dropdown
              ...
              optionLabel="name"
              editable
              placeholder="Select a Alloy Type"
              className="w-full p-2 bg-white border border-gray-400 rounded-md shadow-sm" // Removed transparency and set background to white
            />
          </div>
          <div className="mb-4">
            <Dropdown
